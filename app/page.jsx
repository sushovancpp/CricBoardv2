    ...
    <header className="bg-pitch-900 border-b border-pitch-700 px-4 py-3 flex items-center justify-between sticky top-0 z-20">
      ...
      <div className="flex items-center gap-2.5">
        <div className="flex flex-col items-end gap-1">
          ...
          href="/admin"
          title="Admin Login"
          className="flex items-center gap-1 bg-pitch-800 hover:bg-pitch-700 text-pitch-400 hover:text-white border border-pitch-600 hover:border-pitch-500 font-bold px-2.5 py-1.5 rounded-lg transition-all uppercase tracking-wide text-xs"
        >
          <span>👤</span>
  ...
  return (
    <div className="min-h-screen bg-pitch-950 flex flex-col">
      ...
      <div className="flex-1 px-3 py-4 space-y-3 max-w-lg mx-auto w-full">
        ...
        {isLive && extTotal > 0 && (
          <div className="bg-pitch-900 rounded-2xl border border-pitch-700 px-4 py-3">
            <p className="text-[10px] font-bold text-pitch-500 uppercase tracking-widest mb-2">Extras — {extTotal}</p>
