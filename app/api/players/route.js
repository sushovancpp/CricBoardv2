...
export async function PATCH(req) {
  try {
    ...
    if (body.striker)    Object.assign(inn.striker, body.striker);
    if (body.nonStriker) Object.assign(inn.nonStriker, body.nonStriker);
    if (body.bowler)     Object.assign(inn.bowler, body.bowler);
